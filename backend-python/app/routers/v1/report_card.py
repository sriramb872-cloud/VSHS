...
def generate_report_cards(
    ...
    items = ReportCardService.generate_report_cards(
        db, academic_year_id=academic_year_id, section_id=section_id, term_name=term_name
    )
    write_audit_log(
...
def get_report_card(
    ...
    return ReportCardService.get_report_card(
        db, student_id=student_id, academic_year_id=academic_year_id, school_id=school_id
    )
