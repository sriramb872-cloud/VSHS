...
export const ParentMarksPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Child's Examination Marks</h1>
        <p className="text-sm text-gray-500 mt-1">Monitor your child's evaluated marks across all subjects.</p>
      </div>

      {loading ? (
        <div className="text-center py-12 text-gray-500">Loading marks records...</div>
      ) : marks.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
          <p className="text-gray-500">No marks records found for your child.</p>
        </div>
      ) : (
