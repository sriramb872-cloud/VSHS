// frontend/src/pages/common/Unauthorized.tsx
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-6 text-center bg-white p-8 rounded-lg shadow">
        <div>
          <span className="text-6xl font-extrabold text-red-600">403</span>
          <h2 className="mt-4 text-2xl font-bold text-gray-900">
            Access Denied
          </h2>
          <p className="mt-2 text-sm text-gray-600">
            You do not have the required permissions to access this portal or page.
          </p>
        </div>
